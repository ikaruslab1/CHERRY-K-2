...
export function CertificateCard({ cert, onView, formatDate }: CertificateCardProps) {
    return (
        <div className="bg-white border border-gray-200 rounded-xl p-4 md:p-5 hover:shadow-md transition-all group relative overflow-hidden flex flex-col h-full">
            ...
            <div className="relative z-10 flex flex-col h-full justify-between gap-3">
                <div className="space-y-2">
                    <div className="flex justify-between items-start">
                        <span className="inline-flex items-center px-2 py-0.5 rounded-full text-[10px] font-bold uppercase tracking-wide bg-[var(--color-acid)]/20 text-yellow-900">
                    ...
                    <h3 className="text-base md:text-lg font-bold text-gray-900 leading-tight line-clamp-2 min-h-[2.5rem]" title={cert.events.title}>
                        {cert.events.title}
                    </h3>
