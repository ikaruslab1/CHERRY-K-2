  ...
  return (
    <>
      <button 
        type="button"
        onClick={handleClick}
        className={`flex items-center gap-3 px-4 py-3.5 w-full rounded-xl text-left font-medium transition-all text-black bg-[var(--color-acid)] hover:opacity-90 shadow-sm mb-2 ${
        ...
        {showIOSInstructions && (
          <>
            ...
            <motion.div
              ...
              className="fixed bottom-0 left-0 right-0 md:bottom-auto md:top-1/2 md:left-1/2 md:-translate-x-1/2 md:-translate-y-1/2 bg-white rounded-t-2xl md:rounded-2xl p-6 z-[10000] shadow-2xl w-full md:w-[400px] border border-gray-200"
            >
              <div className="flex justify-between items-center mb-6">
                <h3 className="text-lg font-bold text-gray-900 font-playfair">Instalar en iPhone/iPad</h3>
                <button 
                  onClick={() => setShowIOSInstructions(false)} 
