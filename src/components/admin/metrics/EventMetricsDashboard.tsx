          ...
          return (
            ...
            >
              <div>
                ...
                <div className="space-y-3 bg-gray-50 rounded-xl p-3 mb-4 border border-gray-100">
                    <div className="flex flex-col gap-1 text-sm">
                        <div className="flex justify-between items-end">
                             <span className="text-gray-500 font-medium">Asistencia</span>
                             <span className="font-bold text-gray-900 text-lg">{event.unique_attendees}</span>
                        </div>
                        <div className="flex justify-between items-end">
                    ...
                    <div className="h-2 w-full bg-gray-200 rounded-full overflow-hidden">
                        <div 
                            className={`h-full rounded-full transition-all duration-1000 ${
                                ...
                                attendanceRate > 50 ? 'bg-[var(--color-acid)]' : 'bg-orange-400'
                            }`}
              ...
              <Button 
                ...
                className="w-full bg-white border border-gray-200 text-gray-900 hover:bg-gray-50 hover:border-gray-300 justify-between group shadow-xs"
              >
                 Ver Detalles
