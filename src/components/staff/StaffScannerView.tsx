...
export function StaffScannerView() {
  ...
  return (
      <div className="w-full max-w-sm xs:max-w-md md:max-w-lg mx-auto space-y-6 px-4 xs:px-0 pb-20">
         ...
         <div className="bg-white p-5 xs:p-6 md:p-8 rounded-3xl shadow-sm border border-gray-200 space-y-3 xs:space-y-4 md:space-y-5">
                <div>
                    <h2 className="text-xl xs:text-2xl md:text-3xl font-bold text-center text-gray-900">Scanner de Asistencia</h2>
                    ...
                    {loadingActivities ? (
                        ...
                        <div className="relative">
                            <select
                                ...
                                className="w-full appearance-none bg-gray-50 border border-gray-200 text-gray-900 font-semibold rounded-xl py-3 px-4 pr-10 focus:outline-none focus:ring-2 focus:ring-[#DBF227]"
                            >
                                {events.length === 0 && <option value="" disabled>No hay eventos activos</option>}
                                {events.map(event => (
                                    <option key={event.id} value={event.id} className="bg-white text-black">
                                        {event.title}
                                    </option>
                                ))}
                            </select>
